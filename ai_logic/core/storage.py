"""AI_IN-TERMINAL — ai_logic.core.storage
Version: 1.5 (2026-01-04)

Changelog (1.5)
- Added atomic file writes (write → fsync → rename) for JSON/text.
- Added safe JSON readers that tolerate missing/corrupt files.

Rationale
- Prevents config/memory corruption on power loss or Ctrl+C.
- Keeps I/O predictable while remaining stdlib-only.
"""
